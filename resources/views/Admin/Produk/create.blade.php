            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-header">
                        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px">TAMBAH DATA
                            PRODUK</h5>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <form action="{{ url('Admin/Produk') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-3">
                                                    <label for="exampleSelectBorder">Varian</label>
                                                    <select class="custom-select form-control" name="varian_produk"
                                        ...
                                        <br>
                                            <div class="btn-group float-right">
                                                ...
                                                <button type="button" class="btn-sm btn btn-danger ml-2"
                                                    onclick="window.location.href='{{ url('Admin/Produk') }}'"><i
